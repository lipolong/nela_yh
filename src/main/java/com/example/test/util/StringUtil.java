...
public final class StringUtil {
	...
	public static void main(String[] args) {
		String str01="userAddress=0x0E8AE14d333F8163f7C9572e1bb930213eE5aBcc&title=hsjsjw&description=jsjsjkw%20I%27m&resourceType=1&imgUrl=&fileType=0&fileName=1653638069_small2253269OyK91650639206.jpg&fileSize=243831&transactionHash=0x2a9bd0c8fabf25370c99e28702ea7b6bcb59cb94278d1dcf1c0e2788379cc6c6&nonce=658";
		String decode = URLDecoder.decode(str01, CharsetUtil.charset("UTF-8"));
		Map<String, Object> map = StringJSONUtil.paramsParse(decode);
		JSONObject object = JSONObject.fromObject(map);
		System.out.println(object.toString());

	}
	/**
	 * 将：log{sss="xxx",xxsss="xxx"} 转成JSON字符串格式
	 * @param str 传入字符串
	 * @return null 表示发成错误
	 */
	public static String getStringToJsonString(String str){
		try {
			if(isEmpty(str)){
				return null;
			}
			...
			System.out.println("待转换字符串:"+str);
			String strSub=str.substring(str.indexOf("{"),str.indexOf("}")+1);
			JSONObject object = JSONObject.fromObject(strSub);
	...
	public static String getStringJsonString(String str){
		try {
			if(isEmpty(str)){
				return null;
			}
